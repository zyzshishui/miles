...
class MegatronTrainRayActor(TrainRayActor):
    ...
    def _enable_weight_backup(self) -> bool:
        """Weight backup is needed only when multiple model tags require CPU-side switching (ref / old_actor),
        or in colocate mode where GPU memory is released and weights_getter reads from the CPU backup."""
