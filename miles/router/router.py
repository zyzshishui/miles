...
class MilesRouter:
    ...
    def _update_weight_version_from_response(self, output):
        ...
        if self.max_weight_version is None or current_weight_version > self.max_weight_version:
            ...
            if self.verbose:
                print(f"[miles-router] Updated max weight version to: {self.max_weight_version}")
        elif self.verbose:
            print(f"[miles-router] Current weight version {current_weight_version} <= max {self.max_weight_version}")
